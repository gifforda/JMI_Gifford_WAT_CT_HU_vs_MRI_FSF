...
#  This .R file contains the script to recreate Figure 5 panel B) in the paper.
#  The script reads reconstructed data from the ../data_output/ folder and
#  puts the png image in the  ../figures/ folder.
#  FIGURE 5 B :  FSF v. HU - subjects with BMI >= 25, both temperatures
...
g0 = ggplot(df, aes(x=FSF_Avg, y=HU_Avg, shape=Sex, color=Subject)) +
...
dev.copy(png, file = '../figures/Figure_5b.png', width=1525, height=750)
...
print("**********************************************************")
print("Figure 5b) statistics (R-squared, p-value and confidence interval)")
