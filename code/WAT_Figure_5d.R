...
#  This .R file contains the script to recreate Figure 5 panel D) in the paper.
#  The script reads reconstructed data from the ../data_output/ folder and
#  puts the png image in the  ../figures/ folder.
#  FIGURE 5 D :  FSF v. HU - all subjects, cold temperature
...
dev.copy(png, file = '../figures/Figure_5d.png', width=1525, height=750)
...
print("**********************************************************")
print("Figure 5d) statistics (R-squared, p-value and confidence interval)")
