...
#  This .R file contains the script to recreate Figure 4 in the paper.
#  The script reads reconstructed data from the ../data_output/ folder and
#  puts the png image in the  ../figures/ folder.
#  FIGURE 4 :  FSF v. HU - all subjects, both temperatures
...
dev.copy(png, file = '../figures/Figure_4.png', width=1525, height=750)
...
print("**********************************************************")
print("Figure 4) statistics (R-squared, p-value and confidence interval)")
