...
dev.copy(png, file='../figures/Figure_2a.png', width=850, height=750)
...
print("**********************************************************")
print("Figure 2a) statistics (R-squared, p-value and confidence interval)")
print(summary(mod))
print(confint(mod))
print("**********************************************************")