...
#  This .R file contains the script to recreate Figure 3 panel C) in the paper.
#  The script reads reconstructed data from the ../data_output/ folder and
#  puts the png image in the  ../figures/ folder.
#  FIGURE 3 C :  HU v. HU - subjects with BMI >= 25
...
dev.copy(png, file = '../figures/Figure_3c.png', width=850, height=750)
...
print("**********************************************************")
print("Figure 3c) statistics (R-squared, p-value and confidence interval)")
