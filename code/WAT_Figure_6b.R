...
#  This .R file contains the script to recreate Figure 6 panel B) in the paper.
#  The script reads reconstructed data from the ../data_output/ folder and
#  puts the png image in the  ../figures/ folder.
#  FIGURE 6 B :  FSF v. HU - subjects with BMI < 25, cold temperature
...
dev.copy(png, file = '../figures/Figure_6b.png', width=1525, height=750)
...
print("**********************************************************")
print("Figure 6b) statistics (R-squared, p-value and confidence interval)")
