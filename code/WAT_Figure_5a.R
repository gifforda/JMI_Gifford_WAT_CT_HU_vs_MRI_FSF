...
#  This .R file contains the script to recreate Figure 5 panel A) in the paper.
#  The script reads reconstructed data from the ../data_output/ folder and
#  puts the png image in the  ../figures/ folder.
#  FIGURE 5 A :  FSF v. HU - subjects with BMI < 25, both temperatures
...
dev.copy(png, file = '../figures/Figure_5a.png', width=1525, height=750)
...
print("**********************************************************")
print("Figure 5a) statistics (R-squared, p-value and confidence interval)")
