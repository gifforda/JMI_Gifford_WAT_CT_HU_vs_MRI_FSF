...
#  This .R file contains the script to recreate Figure 6 panel A) in the paper.
#  The script reads reconstructed data from the ../data_output/ folder and
#  puts the png image in the  ../figures/ folder.
#  FIGURE 6 A :  FSF v. HU - subjects with BMI < 25, warm temperature
...
selected_rows = df[,"Temp"]=="TN" & df[,"BMI"]<25
df = df[selected_rows,]
...
dev.copy(png, file = '../figures/Figure_6a.png', width=1525, height=750)
...
print("**********************************************************")
print("Figure 6a) statistics (R-squared, p-value and confidence interval)")
