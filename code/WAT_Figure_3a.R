...
dev.copy(png, file = '../figures/Figure_3a.png', width=850, height=750)
...
print("**********************************************************")
print("Figure 3a) statistics (R-squared, p-value and confidence interval)")
